...
from src.backend.layout_components import build_app_footer_context, build_app_header_context
from src.backend.live_usage import capture_usage
from src.backend.aggregation import fetch_model_catalog
...
LEGACY_IMAGES_DIR = PROJECT_ROOT / "images"
